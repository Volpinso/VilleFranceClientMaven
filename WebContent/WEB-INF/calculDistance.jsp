...
<body>
	...
	<!-- Main Content -->
	<div class="container">
		<h2 class="post-title">Calculer une distance entre deux villes :
		</h2>
		<p></p>
		<div>
			<form method="post" action="ResultatCalcul">
					...
					<div class="col-xs-8 text-center">
						<select class="form-control" name="villeDepart">
							<c:forEach var="i" begin="0" end="${villeFrance.size()-1}"
								step="1">
								<option value="${villeFrance.get(i)}">
									${villeFrance.get(i).getNomCommune()}</option>
							</c:forEach>
						</select>
					</div>
				</div>
