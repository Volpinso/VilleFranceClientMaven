			...
			<div class="form-group">
				<div class="col-xs-8">
					<label for="nomCommune">Nom de la Commune</label> <input
						type="text" class="form-control" name="nomCommune"
						placeholder="Ancien nom : ${nomCommune}">
				</div>
			</div>
			<div class="form-group">
				<div class="col-xs-8">
					<label for="codePostal">Code Postal</label> <input type="text"
						...
						placeholder="Ancien Code : ${codePostal}">
				</div>
			</div>
			<div class="form-group">
				<div class="col-xs-8">
					<label for="libelleAcheminement">Libelle Acheminement</label> <input
						type="text" class="form-control" name="libelleAcheminement"
						placeholder="Ancien Libelle Acheminement : ${libelleAcheminement}">
				</div>
			</div>
			<div class="form-group">
				<div class="col-xs-8">
					<label for="ligne5">Ligne 5</label> <input type="text"
						class="form-control" name="ligne5"
						placeholder="Ancienne ligne 5 : ${ligne5}">
				</div>
			</div>
			<div class="form-group">
				<div class="col-xs-8">
					<label for="latitude">Latitude</label> <input type="text"
						...
						placeholder="Ancienne Latitude : ${latitude}">
				</div>
			</div>
			<div class="form-group">
				<div class="col-xs-8">
					<label for="longitude">Longitude</label> <input type="text"
						...
						placeholder="Ancienne Longitude : ${longitude}">
				</div>
			</div>
			<input type="hidden" class="form-control" name="codeCommuneInsee"
				value="${codeCommuneInsee}">
			<div class="col-xs-8 text-center">
				<button type="submit" class="btn btn-primary">Editer la
					ville</button>
			</div>
		</form>
	</div>
