	...
	<div class="container">
		<form method="post" action="ResultatAjout">
			<div class="form-group">
				<div class="col-xs-8">
					<label for="nomCommune">Code Commune Insee</label> <input
						type="text" class="form-control" name="codeCommuneInsee" required>
				</div>
			</div>
			<div class="form-group">
				<div class="col-xs-8">
					<label for="nomCommune">Nom de la Commune</label> <input
						type="text" class="form-control" name="nomCommune" required>
				</div>
			</div>
			<div class="form-group">
				<div class="col-xs-8">
					<label for="codePostal">Code Postal</label> <input type="text"
						class="form-control" name="codePostal" required>
				</div>
			</div>
			<div class="form-group">
				<div class="col-xs-8">
